...
r = []
while len(r) == 0:
    request = requests.get('https://api.chess.com/pub/player/coolazero/games/{year}/{month:02d}'.format(year=y,month=m))
...
sf = cse.CoupledStockfish('game-from-api.pgn', 'CoolaZero')
b = sf.run()
